...
public class PlayerScoreAdapter extends RecyclerView.Adapter<PlayerScoreAdapter.ViewHolder> {
    ...
    public PlayerScoreAdapter(List<PlayerScore> listPlayers) {
    ...
    @Override
    public void onBindViewHolder(PlayerScoreAdapter.ViewHolder holder, int position) {
        ...
        if(listPlayers.get(position).getPartialScore() < 0 ) {
        ...
        holder.score.setText(df.format(listPlayers.get(position).getPartialScore()));
    }
